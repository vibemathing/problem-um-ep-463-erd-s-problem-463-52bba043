...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-463-erd-s-problem-463-52bba043-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-463"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-463-erd-s-problem-463-52bba043-v1",
      "problem_contract_sha256": "424d2288d2db1c480f345462c39bd25d70138e33f1f1ca261685f061b4683fb2",
      "problem_id": "problem:um-ep-463-erd-s-problem-463-52bba043",
      "route_id": "route:um-ep-463-erd-s-problem-463-52bba043-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-463-erd-s-problem-463-52bba043-source-fidelity-01",
      "graph_id": "graph:um-ep-463-erd-s-problem-463-52bba043-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-463-erd-s-problem-463-52bba043-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-463-erd-s-problem-463-52bba043-root",
          "statement": {
          ...
          "statement_sha256": "d55b1bcfecf16f98ad91caf135d9ccb7af73523e3b28d53810d6f4db4320010f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-463-erd-s-problem-463-52bba043-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-463-erd-s-problem-463-52bba043-root",
      "route_id": "route:um-ep-463-erd-s-problem-463-52bba043-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-463-9ff442ff54db",
        "url": "https://www.unsolvedmath.com/problems/EP-463"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
